...
public class Dashboard_HyattPage extends DashboardWebElementLocators {
	...
	public void clickOnLatestSavedLaunchpad() {
		java.util.List<WebElement> elements = getDriver().findElements(
				By.xpath(Dashboard_AllSavedLaunchPad_Link_Text_Locator));
		getDriver().findElement(
				By.xpath(Dashboard_AllSavedLaunchPad_Link_Text_Locator + "["
						+ elements.size() + "]")).click();
		System.out.println("Last locator: "
				+ Dashboard_AllSavedLaunchPad_Link_Text_Locator + "["
				+ elements.size() + "]");
	}
	...
	public String newLaunchPad(String LaunchpadName) {
		hoverClick(Dashboard_SaveToLaunchpad_Button_Locator);
		click(Dashboard_SaveToLaunchpad_Button_Locator);
		type(Dashboard_AddToNewLaunchpad_Textbox_Locator, LaunchpadName);
		String Launchpadname = getText(Dashboard_AddToNewLaunchpad_Textbox_Locator);
		put("Launchpadname", Launchpadname);
		click(Dashboard_AddNew_Button_Locator);
		return Launchpadname;

	}
	
	public void verifyLaunchpadPresent(String Launchpadname)
	{
		waitForTextInSection(Dashboard_Launchpad_Present_Locator, Launchpadname, 2);
